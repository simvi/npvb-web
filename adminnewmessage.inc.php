...
if (!peutAccederPage($Joueur, 'adminnewmessage')){ require("accueil.inc.php"); return;}
	...
	if (!$ErreurDonnees){
		...
		switch ($Mode){
			...
			case "Modif":
				...
				if (!mySql_query("UPDATE NPVB_Joueurs SET".(($MotDePasse)?" Password='".old_password_hash($MotDePasse)."',":"")." Etat='".$Etat."', Adhesion='".$AdhesionMySQL."', Nom='".$Nom."', Prenom='".$Prenom."', Sexe='".$Sexe."', DateNaissance='".$DateNaissanceMySQL."', Profession='".$Profession."', Adresse='".$Adresse."', CPVille='".$CPVille."', Telephones='".$Telephones."', Email='".$Email."', Accord='".$Accord."', PremiereAdhesion='".$PremiereAdhesionMySQL."', License='".$LicenseMySQL."', NumeroLicence='".$NumLicence."' WHERE (Pseudonyme='".$Membre."')", $sdblink)) {
