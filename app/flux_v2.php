...
*/
	...
	//
		...
		$request = "SELECT DateHeure, Libelle, Etat, Titre, Intitule, Lieu, Adresse, Adversaire, Analyse, InscritsMax FROM NPVB_Evenements WHERE (DateHeure > 20190000000000)";	
		$result = mysql_query($request) or die('Errant query:  '.$query);
	...
	//
			...
			$testPresenceRequest = "SELECT * FROM NPVB_Presence WHERE (Joueur='".$pseudo."' AND DateHeure='".$date."' AND Libelle='".$libelle."')";
                    ...
                    $nbSubscribeRequest = "SELECT count(*) FROM NPVB_Presence WHERE (DateHeure='".$date."' AND Libelle='".$libelle."')";
                    ...
                    if ($nbSubscribers[0] < $maxSubscribers[0] || $presence == 'n' || $libelle != 'SEANCE') {
